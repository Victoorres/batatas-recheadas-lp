  ...
  const benefits = [
    {
      ...
      description:
        "Comece com menos de R$ 100 e tenha potencial de faturar milhares por mês",
      highlight: false,
    },
    {
      ...
      title: "Alta Demanda",
      description:
        "Batatas recheadas são um dos produtos mais pedidos no delivery",
      highlight: false,
    },
    {
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">
            ...
            <span className="text-yellow-400">curso</span>?
          </h2>
          <p className="text-xl text-gray-300">
            Vantagens que fazem toda a diferença no seu sucesso
          </p>
        </div>
        ...
        <div className="bg-black rounded-3xl p-8 md:p-12 border border-gray-800">
          <div className="text-center mb-8">
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
              ...
              <span className="text-yellow-400">hoje</span>:
            </h3>
            <p className="text-gray-400">
              Conteúdo completo para transformar sua vida financeira
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            {differentials.map((differential, index) => (
              <div
                key={index}
                className="flex items-start gap-4 bg-gray-800 p-4 rounded-xl border border-gray-700"
              >
          ...
          <div className="text-center bg-gradient-to-r from-red-900/50 to-red-800/50 rounded-2xl p-6 mb-8 border border-red-500/30">
            <div className="mb-4">
              <div className="text-gray-400 text-lg mb-2">
                Valor total de tudo isso:
              </div>
              <div className="text-3xl font-bold text-red-400 line-through mb-2">
                R$ 1.497,00
              </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-400 mt-4 flex flex-col sm:flex-row gap-1 sm:gap-2 justify-center">
